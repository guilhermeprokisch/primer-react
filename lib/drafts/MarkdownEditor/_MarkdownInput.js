...
var _useBacklinkSuggestions = require('./suggestions/_useBacklinkSuggestions.js');
...
const MarkdownInput = /*#__PURE__*/React.forwardRef(({
  ...
  } = _useBacklinkSuggestions.useBacklinkSuggestions(backlinkSuggestions !== null && backlinkSuggestions !== void 0 ? backlinkSuggestions : emptyArray);
  const triggers = React.useMemo(() => [mentionsTrigger, referencesTrigger, emojiTrigger, backlinksTrigger], [mentionsTrigger, referencesTrigger, emojiTrigger, backlinksTrigger]);
  ...
  }, [event, calculateEmojiSuggestions, calculateMentionSuggestions, calculateReferenceSuggestions, calculateBacklinkSuggestions,
  // The triggers never actually change because they are statically defined
  emojiTrigger, mentionsTrigger, referencesTrigger, backlinksTrigger]);
