...
declare const SelectMenu: React.ForwardRefExoticComponent<Omit<SelectMenuInternalProps, "ref"> & React.RefAttributes<HTMLDetailsElement>>;
 ...
 */
declare const _default: React.ForwardRefExoticComponent<Omit<SelectMenuInternalProps, "ref"> & React.RefAttributes<HTMLDetailsElement>> & {
    ...
    Modal: React.ForwardRefExoticComponent<Omit<Pick<{
