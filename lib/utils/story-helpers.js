...
const withThemeProvider = (Story, context) => {
  ...
  if (colorScheme === 'all') {
    ...
    }, /*#__PURE__*/React__default.default.createElement(GlobalStyleMultiTheme, null), Object.keys(theme.colorSchemes).map(scheme => /*#__PURE__*/React__default.default.createElement(ThemeProvider.default, {
      key: scheme,
