...
export declare const FormControlContext: React.Context<FormControlContext>;
declare const _default: React.ForwardRefExoticComponent<{
    ...
    } & React.PropsWithChildren<import("../_InputLabel").LabelProps | import("../_InputLabel").LegendOrSpanProps> & {
