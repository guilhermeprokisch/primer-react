...
const Item = /*#__PURE__*/React__default.forwardRef((itemProps, ref) => {
  ...
  return /*#__PURE__*/React__default.createElement(StyledItem, _extends({
    ...
    variant: variant,
    disabled: disabled
  }, typeof TrailingVisual === 'object' ? /*#__PURE__*/React__default.createElement(TrailingVisual, null) : TrailingVisual) : TrailingIcon || trailingText ? /*#__PURE__*/React__default.createElement(TrailingContent, {
    variant: variant,
    disabled: disabled
